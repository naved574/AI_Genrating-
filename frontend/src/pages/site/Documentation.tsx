  ...
  return (
    <>
      <MarketingHero
        ...
        category="Developers"
        title="Documentation"
        description="Reference docs for the Luminal platform."
        primaryCta={{ to: "/dashboard/generate", label: "Try it" }}
        secondaryCta={{ to: "/pricing", label: "See pricing" }}
      />
      <FeatureGrid
        features={[
          { icon: Sparkles, t: "Polished by default", d: "Everything in Documentation comes pre-tuned for studio-quality output." },
