  ...
  return (
    <>
      <MarketingHero
        ...
        category="Showcase"
        title="Explore"
        description="Browse millions of generations from the Luminal community."
        primaryCta={{ to: "/dashboard/generate", label: "Try it" }}
        secondaryCta={{ to: "/pricing", label: "See pricing" }}
      />
      <FeatureGrid
        features={[
          { icon: Sparkles, t: "Polished by default", d: "Everything in Explore comes pre-tuned for studio-quality output." },
