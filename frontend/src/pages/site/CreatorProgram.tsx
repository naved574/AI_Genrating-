  ...
  return (
    <>
      <MarketingHero
        ...
        description="For ambitious creators shipping with Luminal."
        primaryCta={{ to: "/dashboard/generate", label: "Try it" }}
        secondaryCta={{ to: "/pricing", label: "See pricing" }}
      />
      <FeatureGrid
        features={[
          { icon: Sparkles, t: "Polished by default", d: "Everything in Creator Program comes pre-tuned for studio-quality output." },
