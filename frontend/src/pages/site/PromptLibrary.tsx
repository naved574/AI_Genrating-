  ...
  return (
    <>
      <MarketingHero
        ...
        description="Curated prompts organized by style, subject, and model."
        primaryCta={{ to: "/dashboard/generate", label: "Try it" }}
        secondaryCta={{ to: "/pricing", label: "See pricing" }}
      />
      <FeatureGrid
        features={[
          { icon: Sparkles, t: "Polished by default", d: "Everything in Prompt library comes pre-tuned for studio-quality output." },
