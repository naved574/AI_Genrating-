  ...
  return (
    <>
      <MarketingHero
        ...
        category="Press"
        title="Press kit"
        description="Logos, screenshots, and brand guidelines."
        primaryCta={{ to: "/dashboard/generate", label: "Try it" }}
        secondaryCta={{ to: "/pricing", label: "See pricing" }}
      />
      <FeatureGrid
        features={[
          { icon: Sparkles, t: "Polished by default", d: "Everything in Press kit comes pre-tuned for studio-quality output." },
